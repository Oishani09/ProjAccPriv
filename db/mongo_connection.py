"""
MongoDB Connection Module — COMMENTED OUT (replaced by bq_connection.py)

To restore MongoDB, uncomment all code below and update the imports
in server/routers/*.py back to mongo_connection.
"""
